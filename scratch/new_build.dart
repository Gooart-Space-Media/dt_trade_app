              ...
              children: [
                ...
                Expanded(
                  child: TextFormField(
                    controller: _winCtrl,
                    keyboardType: const TextInputType.numberWithOptions(decimal: true),
                    decoration: InputDecoration(labelText: '胜率 (${riskPct.toStringAsFixed(0)}%)', border: OutlineInputBorder(borderRadius: BorderRadius.circular(12))),
                    onChanged: (v) {
              ...
              children: [
                Expanded(
                  child: TextFormField(
                    ...
                    keyboardType: const TextInputType.numberWithOptions(decimal: true),
                    decoration: InputDecoration(labelText: '单笔风险 (${riskPct.toStringAsFixed(0)}%)', border: OutlineInputBorder(borderRadius: BorderRadius.circular(12))),
                    onChanged: (v) {
        ...
        if (constraints.maxWidth > 800) {
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                leftContent,
                if (simResult != null) const SizedBox(height: 16),
                rightContent,
              ],
            ),
          );
