...
code = code.replace("countdown = '距 15:00 伦敦盘 ${dh}h${dm.toString().padLeft(2, '0')}m';", "countdown = AppLocalizations.of(context)!.radarCount2(dh.toString(), dm.toString().padLeft(2, '0'));");
...
code = code.replace("countdown = '距 20:30 主战场 ${dh}h${dm.toString().padLeft(2, '0')}m';", "countdown = AppLocalizations.of(context)!.radarCount3(dh.toString(), dm.toString().padLeft(2, '0'));");
...
code = code.replace("countdown = '距重叠期结束 ${dh}h${dm.toString().padLeft(2, '0')}m';", "countdown = AppLocalizations.of(context)!.radarCount4(dh.toString(), dm.toString().padLeft(2, '0'));");
...
code = code.replace("countdown = '距明日 07:00 晨盘 ${dh}h${dm.toString().padLeft(2, '0')}m';", "countdown = AppLocalizations.of(context)!.radarCount5(dh.toString(), dm.toString().padLeft(2, '0'));");

fs.writeFileSync('lib/main.dart', code);
console.log("Replaced radar translation logic perfectly.");
