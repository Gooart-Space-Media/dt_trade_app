...
// 1. Inject _buildPairButton into _LotSizeCalcPageState
const classStart = code.indexOf('class _LotSizeCalcPageState');
const buildStart = code.indexOf('  Widget build(BuildContext context) {', classStart);
...
code = code.substring(0, buildStart) + newHelper + code.substring(buildStart + "  Widget build(BuildContext context) {".length);
...
console.log('Grouped pairs into tiers safely!');
