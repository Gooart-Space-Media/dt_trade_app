const fs = require('fs');
let lines = fs.readFileSync('lib/main.dart', 'utf-8').split('\n');

const start = lines.findIndex(l => l.includes('大马时间盘口时段雷达条'));
const end = lines.findIndex((l, i) => i > start && l.includes('Expanded(') && lines[i+1].includes('IndexedStack('));
