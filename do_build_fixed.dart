  ...
  String inputs1 = r'''
            ...
            Expanded(
              child: TextFormField(
                controller: _winCtrl,
                keyboardType: const TextInputType.numberWithOptions(decimal: true),
                decoration: InputDecoration(isDense: true, contentPadding: const EdgeInsets.symmetric(horizontal: 10, vertical: 8), labelText: '胜率 (%)', border: OutlineInputBorder(borderRadius: BorderRadius.circular(12))),
                onChanged: (v) {
  ...
  String inputs2 = r'''
            Expanded(
              child: TextFormField(
                ...
                keyboardType: const TextInputType.numberWithOptions(decimal: true),
                decoration: InputDecoration(isDense: true, contentPadding: const EdgeInsets.symmetric(horizontal: 10, vertical: 8), labelText: '单笔风险 (%)', border: OutlineInputBorder(borderRadius: BorderRadius.circular(12))),
                onChanged: (v) {
        ...
        final leftContent = Column(
          ...
          children: [
            ...
            if (constraints.maxWidth > 800)
              ...
              Column(
                children: [
                  Row(children: [ '''+inputs1+r''' ]),
                  const SizedBox(height: 8),
                  Row(children: [ '''+inputs2+r''' ]),
                ],
              ),
            const SizedBox(height: 8),
            FilledButton.icon(
