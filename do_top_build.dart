  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        // 1. Top Controls (Banner + Inputs + Button)
                ...
                children: [
                  Expanded(
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(isDense: true, contentPadding: const EdgeInsets.symmetric(horizontal: 10, vertical: 10), labelText: '初始本金 (USD)', border: OutlineInputBorder(borderRadius: BorderRadius.circular(8))),
                  ...
                  Expanded(
                    child: TextFormField(
                      controller: _winCtrl,
                      keyboardType: const TextInputType.numberWithOptions(decimal: true),
                      decoration: InputDecoration(isDense: true, contentPadding: const EdgeInsets.symmetric(horizontal: 10, vertical: 10), labelText: '交易胜率 (%)', border: OutlineInputBorder(borderRadius: BorderRadius.circular(8))),
                  ...
                  Expanded(
                    child: TextFormField(
                      ...
                      keyboardType: const TextInputType.numberWithOptions(decimal: true),
                      decoration: InputDecoration(isDense: true, contentPadding: const EdgeInsets.symmetric(horizontal: 10, vertical: 10), labelText: '单笔总风险 (%)', border: OutlineInputBorder(borderRadius: BorderRadius.circular(8))),
                  ...
                  Expanded(
                    child: DropdownButtonFormField<double>(
                      isExpanded: true,
                      value: rr,
                      decoration: InputDecoration(isDense: true, contentPadding: const EdgeInsets.symmetric(horizontal: 10, vertical: 10), labelText: '基础盈亏比', border: OutlineInputBorder(borderRadius: BorderRadius.circular(8))),
                      items: const [
        ...
        // 2. Left Results (Cards)
        Widget resultsLeft = simResult == null ? const SizedBox.shrink() : Container(
        ...
        // 3. Right Results (Chart & Grid)
        Widget resultsRight = simResult == null ? const SizedBox.shrink() : Container(
          decoration: BoxDecoration(
            color: isDark ? const Color(0xFF1E293B) : Colors.white,
            borderRadius: BorderRadius.circular(16),
            border: Border.all(color: isDark ? Colors.grey[800]! : Colors.grey[300]!),
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    const SizedBox(width: 6),
                    const Text('资金净值走势对比 (Dual Equity Curve):', style: TextStyle(fontSize: 12, color: Colors.grey, fontWeight: FontWeight.bold)),
                    const Spacer(),
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                if (simResult != null) ...[
                  const SizedBox(height: 16),
                  // On mobile, the charts need a constrained height
                  SizedBox(
                    height: 550, // Fixed height for left box on mobile
                    child: resultsLeft,
                  ),
                  const SizedBox(height: 16),
                  SizedBox(
                    height: 600, // Fixed height for right box on mobile
                    child: resultsRight,
                  ),
                ]
              ],
...
''';
  ...
  // Restore the original _buildResultCard layout padding and sizes
  String cardFix = r'''
